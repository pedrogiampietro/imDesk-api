...
router.post("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const existingEquipmentType = yield prisma.equipmentCompany.findFirst({});
        ...
        const createTicketPriority = yield prisma.equipmentType.create({
            data: {
                name: name,
                companies: {
...
router.get("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const getAllTicketPriority = yield prisma.equipmentType.findMany({
            include: {
                companies: true,
            },
        });
