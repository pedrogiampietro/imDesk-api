                                                ...
                                                <tr>
                                                   <td class="x_primary-font x_text" style="word-break: break-word; font-family: Arial,sans-serif; font-size: 14px; color: #333333; line-height: 170%; border-collapse: collapse;">
                                                      <div id="x_text4" class="x_mktoText">
                                                         ...
                                                         <p style="text-align: justify;"><span style="font-size: 16px;"> Informamos que foi aberto um novo registro no Sistema de Atendimento a usuários com o resumo de <strong>${getDescription.slice(
                                                           0,
                                                           150
                                                         )}</strong>. </span></p>
